...
function OrdenCard({ orden, onEdit, onDragStart }) {
    ...
    return (
        <div
            ...
            className="cursor-grab rounded-xl border border-black/10 bg-white p-3 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md active:cursor-grabbing"
        ...
        >
            ...
            <div className="mt-3 grid gap-1 text-xs text-slate-600">
                <div className="flex items-center gap-2"><Phone className="h-3.5 w-3.5 text-[#131E5C]" /> <span className="truncate">{orden.telefono || "—"}</span></div>
                <div className="flex items-center gap-2"><CarFront className="h-3.5 w-3.5 text-[#131E5C]" /> <span className="truncate">{orden.modelo || orden.vin || "—"}</span></div>
                <div className="flex items-center gap-2"><UserCog className="h-3.5 w-3.5 text-[#131E5C]" /> <span className="truncate">{orden.tecnico || "Sin técnico"}</span></div>
