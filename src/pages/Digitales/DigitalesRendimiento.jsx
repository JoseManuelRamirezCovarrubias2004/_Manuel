    ...
    return (
        <div className="min-h-full bg-slate-50 p-4 md:p-6">
            <div className="mx-auto max-w-[1500px] space-y-5">
                <header className="rounded-3xl bg-[#131E5C] p-5 text-white shadow-sm md:p-6">
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                        <div>
                            <div className="flex items-center gap-2 text-sm text-blue-100">
                                <BarChart3 size={18} /> Analítica comercial digital
                            </div>
                            <h1 className="mt-2 text-2xl font-semibold md:text-3xl">Resultados por asesor digital</h1>
                            <p className="mt-2 max-w-3xl text-sm text-blue-100">
                                Mide mensajes, plantillas, clientes atendidos, respuestas y seguimiento real por cada línea de WhatsApp.
                            </p>
                        </div>
                        <button
                            type="button"
                            onClick={() => setReloadKey((value) => value + 1)}
                            className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-medium text-[#131E5C] hover:bg-blue-50"
                        >
